...
// game options
#define GAME_TEXT_SPEED OPTIONS_TEXT_SPEED_MID
#define GAME_BATTLE_STYLE OPTIONS_BATTLE_STYLE_SHIFT
#define HIDE_PREVIOUS_QUEST_LOG FALSE
#define FIX_POKEMON_EVOLUTIONS TRUE
#define IV_BUGFIX TRUE
#define BUILTIN_EXP_SHARE TRUE
#define BUILD_VERSION "v0.1.0: f00dbabe"
