...
const u8 gText_MenuDebug_FeatureFlags[] = _("Flags");
const u8 gText_BuildVersion[] = _(BUILD_VERSION);
const u8 gText_MenuSafariStats[] = _("{STR_VAR_1}/{STR_VAR_2}\nBALLS  {STR_VAR_3}");
const u8 gText_TimesStrVar1[] = _("×{STR_VAR_1}");
const u8 gText_LevelCap[] = _("{STR_VAR_1}");
...
const u8 gText_LevelCapName[] = _("Current Level Cap");
const u8 gText_HideQuestLog[] = _("Hide Quest Log");
const u8 gText_Evolution_Fix[] = _("Evolution Fix");
const u8 gText_IV_Fix[] = _("IV Fix");
const u8 gText_Builtin_EXP_Share[] = _("Builtin Exp Share");
