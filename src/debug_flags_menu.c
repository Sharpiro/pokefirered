...
static EWRAM_DATA struct DebugOptionMenu *sOptionMenuPtr = NULL;
...
void CB2_DebugOptionsMenuFromStartMenu(void)
{
    u8 i;

    if (gMain.savedCallback == NULL)
        gMain.savedCallback = CB2_ReturnToFieldWithOpenMenu;
    sOptionMenuPtr = AllocZeroed(sizeof(struct DebugOptionMenu));
